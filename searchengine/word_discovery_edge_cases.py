...
#         "description": "Basic single character errors",
#         "cases": [
#             {"query": "the dog is bleu",        "notes": "Simple substitution: e/u swap → blue",             "expect": {"bleu": "blue"}},
#             {"query": "she is hunrgy",           "notes": "Transposition: r and g swapped → hungry",          "expect": {"hunrgy": "hungry"}},
#             {"query": "the quik brown fox",      "notes": "Missing letter c → quick",                         "expect": {"quik": "quick"}},
#             {"query": "she recieved a gift",     "notes": "Common misspelling ie vs ei → received",           "expect": {"recieved": "received"}},
#             {"query": "the ballon is red",       "notes": "Missing repeated l → balloon",                     "expect": {"ballon": "balloon"}},
#             {"query": "she is sucessful",        "notes": "Missing repeated c and s → successful",            "expect": {"sucessful": "successful"}},
#         ]
#     },
...
#         "description": "Errors from hitting adjacent keys on keyboard",
#         "cases": [
#             {"query": "thr dog is brown",        "notes": "r is adjacent to e on keyboard → the",             "expect": {"thr": "the"}},
#             {"query": "the cat ir cute",         "notes": "r is adjacent to s on keyboard → is",              "expect": {"ir": "is"}},
#             {"query": "i luv music",             "notes": "u adjacent to i, missing o → love",                "expect": {"luv": "love"}},
#             {"query": "thw quick brown fox",     "notes": "w is adjacent to e on keyboard → the",             "expect": {"thw": "the"}},
#             {"query": "school iz fun",           "notes": "z is adjacent to s on keyboard → is",              "expect": {"iz": "is"}},
#             {"query": "i wsnt to go home",       "notes": "s is adjacent to a on keyboard → want",            "expect": {"wsnt": "want"}},
#             {"query": "the wotk is hard",        "notes": "o is adjacent to r on keyboard → work",            "expect": {"wotk": "work"}},
#             {"query": "she playd the game",      "notes": "Missing e at end → played",                        "expect": {"playd": "played"}},
#             {"query": "i liek dogs",             "notes": "i and e transposed → like",                        "expect": {"liek": "like"}},
#             {"query": "the hoyse is big",        "notes": "o is adjacent to u on keyboard → house",           "expect": {"hoyse": "house"}},
#         ]
#     },
...
#         "description": "POS pattern matching picks the right correction",
#         "cases": [
#             {"query": "the sky is bleu today",   "notes": "[be] ___ [noun] → adjective blue not verb blew",  "expect": {"bleu": "blue"}},
#             {"query": "the wind bleu hard",      "notes": "[noun] ___ [adverb] → verb blew not adjective blue", "expect": {"bleu": "blew"}},
#             {"query": "i red the book",          "notes": "[pronoun] ___ [article] → verb read not adjective red", "expect": {"red": "read"}},
#             {"query": "she through the ball",    "notes": "[pronoun] ___ [article] → verb threw",            "expect": {"through": "threw"}},
#         ]
#     },
...
#         "description": "Multiple typos in one query — all sent to Redis in one batch",
#         "cases": [
#             {"query": "teh dgo is bleu",         "notes": "Three errors — all sent to Redis in ONE pipeline batch", "expect": {"teh": "the", "dgo": "dog", "bleu": "blue"}},
#             {"query": "she iz vrey hunrgy",      "notes": "Three errors: keyboard, transposition, transposition",   "expect": {"iz": "is", "vrey": "very", "hunrgy": "hungry"}},
#             {"query": "wher iz africn locatd",   "notes": "Four errors — tests multi-pass POS neighbor walk + batch", "expect": {"wher": "where", "iz": "is", "africn": "african", "locatd": "located"}},
#             {"query": "i cant wayt too see yuo", "notes": "Multiple errors, some valid words stay unchanged",       "expect": {"wayt": "wait", "yuo": "you"}},
#             {"query": "i am happppy today",      "notes": "Repeated letters — too many p's → happy",               "expect": {"happppy": "happy"}},
#         ]
#     },
...
#         "description": "Consecutive unknown words — tests multi-pass walk past unknowns",
#         "cases": [
#             {"query": "i visited nw yrok",               "notes": "Two adjacent unknowns — walk past both to find context",     "expect": {"nw": "new", "yrok": "york"}},
#             {"query": "i love hihg scool",               "notes": "Adjacent pair — high school",                                "expect": {"hihg": "high", "scool": "school"}},
#             {"query": "ths iz the dog",                  "notes": "Two adjacent unknowns at start — limited left context",      "expect": {"ths": "this", "iz": "is"}},
#             {"query": "wher iz teh dog tht i luv",       "notes": "Five unknowns — some adjacent, full multi-pass stress test", "expect": {"wher": "where", "iz": "is", "teh": "the", "tht": "that", "luv": "love"}},
#             {"query": "ths iz teh dg tht i luv",         "notes": "Six unknowns — maximum stress test for batch + multi-pass",  "expect": {"ths": "this", "iz": "is", "teh": "the", "dg": "dog", "tht": "that", "luv": "love"}},
#         ]
#     },
...
#         "description": "Bigram and trigram detection from RAM cache",
#         "cases": [
#             {"query": "new york food near me",           "notes": "Should detect bigram: new york",              "expect": {}},
#             {"query": "new york city food",              "notes": "Should detect trigram: new york city",         "expect": {}},
#             {"query": "african american history month",  "notes": "Should detect bigram: african american",       "expect": {}},
#             {"query": "civil rights movement history",   "notes": "Should detect bigram: civil rights",           "expect": {}},
#         ]
#     },
...
#         "description": "Corrected words form new n-grams — tests Step 6 re-check",
#         "cases": [
#             {"query": "new yrok city",           "notes": "yrok → york then Step 6 re-checks and finds trigram",          "expect": {"yrok": "york"}},
#             {"query": "african amrican history", "notes": "amrican → american then Step 6 finds bigram african american",  "expect": {"amrican": "american"}},
#         ]
#     },
...
#         "description": "Errors at start or end — limited neighbor context",
#         "cases": [
#             {"query": "bleu is my favorite color", "notes": "Error at position 0 — no left neighbor",      "expect": {"bleu": "blue"}},
#             {"query": "my favorite color is bleu", "notes": "Error at last position — no right neighbor",  "expect": {"bleu": "blue"}},
#             {"query": "hunrgy",                    "notes": "Single word — no context at all",             "expect": {"hunrgy": "hungry"}},
#             {"query": "dgo",                       "notes": "Single misspelled word",                     "expect": {"dgo": "dog"}},
#         ]
#     },
...
#         "description": "Clean queries — all words in RAM, Redis NOT called",
#         "cases": [
#             {"query": "where is africa located", "notes": "All words valid — no Redis", "expect": {}},
#             {"query": "the quick brown fox",     "notes": "All words valid",            "expect": {}},
#             {"query": "african food near me",    "notes": "All words valid",            "expect": {}},
#             {"query": "new york city",           "notes": "All words valid including proper nouns", "expect": {}},
#         ]
#     },
...
#         "description": "Pure stopword queries — no Redis, no corrections",
#         "cases": [
#             {"query": "the and is", "notes": "Pure stopwords — all tagged from STOPWORDS dict", "expect": {}},
#             {"query": "i am the",  "notes": "Pure stopwords",                                   "expect": {}},
#         ]
#     },
...
#         "description": "Short words with typos — limited fuzzy candidates",
#         "cases": [
#             {"query": "i wnt to go",  "notes": "3-letter word missing vowel → want",   "expect": {"wnt": "want"}},
#             {"query": "th dog is cute","notes": "2-letter word missing vowel → the",   "expect": {"th": "the"}},
#             {"query": "she si happy", "notes": "2-letter transposition → is",          "expect": {"si": "is"}},
#         ]
#     },
...
#         "description": "Names, places, and proper nouns with typos",
#         "cases": [
#             {"query": "i visited goergia",    "notes": "State name with transposition → georgia",  "expect": {"goergia": "georgia"}},
#             {"query": "atlnta is a city",     "notes": "City name missing vowel → atlanta",        "expect": {"atlnta": "atlanta"}},
#             {"query": "howard univeristy",    "notes": "Proper noun context → university",         "expect": {"univeristy": "university"}},
#         ]
#     },
...
#         "description": "Words with attached punctuation marks",
#         "cases": [
#             {"query": "is the dog bleu?",        "notes": "Error before question mark",                  "expect": {"bleu": "blue"}},
#             {"query": "the dog is bleu, not red","notes": "Error before comma",                          "expect": {"bleu": "blue"}},
#             {"query": "i love music!",           "notes": "Valid sentence with exclamation — no correction", "expect": {}},
#         ]
#     },
...
#         "description": "Suffix detection refines POS prediction in Step 3.5",
#         "cases": [
#             {"query": "she is very happly",      "notes": "Suffix -ly → adverb prediction → happily",     "expect": {"happly": "happily"}},
#             {"query": "the importnt meeting",    "notes": "Suffix -ant → adjective prediction → important","expect": {"importnt": "important"}},
#             {"query": "she was very successfl",  "notes": "Suffix -ful → adjective → successful",         "expect": {"successfl": "successful"}},
#         ]
#     },
...
#         "description": "Sentences with numbers or mixed content",
#         "cases": [
#             {"query": "i have 3 dgs",              "notes": "Number followed by typo → dogs",          "expect": {"dgs": "dogs"}},
#             {"query": "the year 1965 was importnt","notes": "Typo after a year number → important",    "expect": {"importnt": "important"}},
#         ]
#     },
# }
...
#     # Only flag as redis_correction if it was NOT a stopword fuzzy match
#     if term["status"] in ("corrected", "pos_corrected") and not term["is_stopword"]:
#         entry["redis_correction"] = {
#             "original":          term["word"],
#             "corrected":         term.get("corrected"),
#             "corrected_display": term.get("corrected_display"),
...
#     # Redis batch summary — only non-stopword corrections actually hit Redis
#     redis_words = [
#         {
#             "position":      t["position"],
#             "original_word": t["word"],
...
#         }
#         for t in terms
#         if t["status"] in ("corrected", "pos_corrected") and not t["is_stopword"]
#     ]
...
#     # Stopword fuzzy corrections — caught in RAM, never sent to Redis
#     stopword_corrections = [
#         {
#             "position":  t["position"],
#             "original":  t["word"],
...
#         }
#         for t in terms
#         if t["status"] == "corrected" and t["is_stopword"]
#     ]
...
#         "batch_details":         redis_words,
#         "still_unknown":         unknown_words,
#         "stopword_corrections":  stopword_corrections,
#         "note": (
#             f"All {total_redis} unknown words sent to Redis in ONE pipeline batch call"
#             if total_redis > 1 else
#             "Single word sent to Redis"
...
#             "predicted_pos": t.get("predicted_pos"),
#             "matched_from": (
#                 "stopword_exact"   if t["is_stopword"] and t["status"] == "valid" else
#                 "stopword_fuzzy"   if t["is_stopword"] and t["status"] == "corrected" else
#                 "ram_exact_match"  if t["status"] == "valid" else
#                 "redis_correction" if t["status"] in ("corrected", "pos_corrected") else
#                 "unknown"
#             ),
...
#         "single_word_query":             stats["total_words"] == 1,
#         "redis_batch_triggered":         total_redis > 1,
#         "stopword_fuzzy_corrections":    len(stopword_corrections),
#         "ngram_formed_after_correction": any(n.get("from_correction") for n in ngrams),
#     }
...
def _build_word_debug(term: dict) -> dict:
    ...
    # Show all Redis candidates that were considered
    if term.get("redis_suggestions"):
        entry["redis_candidates"] = [
            {
                "term":       s["term"],
                "pos":        s["pos"],
                "rank":       s["rank"],
            ...
            for s in term["redis_suggestions"]
        ]
